...
<div class="banner_1">
	<div class="container">
		<div id="search_wrapper1">
		   <h2 class="white"><i>“The definition of insanity is doing the same thing over and over and expecting different results.”</i> –Benjamin Franklin</h2>
		</div>
   </div> 
</div>
			<div class="container">
...
<div class="container">
    <div class="single">  
        <div class="col-sm-10 follow_left">
			<h3><center><u>MBA</u></center></h3><br><br>
             <div class="jobs_follow jobs-single-item">
				<div class="thumb"><img src="images/fsofm.jpg" class="img-responsive" alt=""/></div>
				<div class="thumb_right">
				
				<h6 class="title"><a href="#">Frankfurt School of Finance and Management</a></h6>
				<span class="meta">Frankfurt, Germany</span>
				<ul class="top-btns">
					<li>
						<a href="#" class="btn_1 fa fa-star-o icon_2"></a>
					</li>
				</ul>
				<p><h6>Masters in Business Administration</h6></p>
				<p><strong>1st Year Total Fees</strong> : Rs. 35.4 Lakhs</p>
				<p><strong>Eligibility :</strong> TOEFL: 90<br>IELTS: 7<br>GRE: Accepted</p>
                <hr>
		   ...
		   <div class="jobs_follow jobs-single-item">
				...
				<span class="meta">Wollongong</span>
				<ul class="top-btns">
					<li>
						<a href="#" class="btn_1 fa fa-star-o icon_2"></a>
					</li>
				</ul>
				<p><h6>Master of Business Administration- MBA</h6></p>
				<p><strong>1st Year Total Fees</strong> Rs 27.1 Lakhs</p>
				<p><strong>Eligibility :</strong> TOEFL: 88<br>IELTS: 6.5<br>PTE: 64/p>
                <hr>
		    ...
		    <div class="jobs_follow jobs-single-item">
				...
				<h6 class="title"><a href="#">IESEG School of Management</a></h6>
				<span class="meta">Lille, France</span>
				<ul class="top-btns">
					<li>
						<a href="#" class="btn_1 fa fa-star-o icon_2"></a>
					</li>
				...
				<p><h6>International MBA</h6></p>
				<p><strong>1st Year Total Fees</strong> Rs 20.2 Lakhs </p>
		    ...
		    <div class="jobs_follow jobs-single-item">
				...
				<h6 class="title"><a href="#">EU Business School- Germany</a></h6>
				...
				<p><h6>Master of Business Administration(MBA)</h6></p>
				<p><strong>1st Year Total Fees</strong> Rs 23.2 Lakhs</p>
				<p><strong>Eligibility :</strong> TOEFL: 89<br>IELTS: 6.5<br>PTE: 59<br>GRE: Accepted</p>
                <hr>
                <a href="mail3.php" class="btn btn-default pull-left"  style="margin-right:16px">Apply in this College</a>
		    ...
		    <div class="jobs_follow jobs-single-item">
				...
				<h6 class="title"><a href="#">The University of Melbourne</a></h6>
				<span class="meta">Melbourne, Australia</span>
				<ul class="top-btns">
					<li>
						<a href="#" class="btn_1 fa fa-star-o icon_2"></a>
					</li>
				...
				<p><strong>1st Year Total Fees</strong> Rs 57.3 Lakhs </p>
				<p><strong>Eligibility :</strong> TOEFL: 102<br>IELTS: 7<br>GRE: Accepted</p>
                <hr>
                <a href="mail3.php" class="btn btn-default pull-left"  style="margin-right:16px">Apply in this college</a>
