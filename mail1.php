...
$mail = new PHPMailer();
  ...
  $mail->Body =($row["username"])." applied for the job of "."<i>NTPC-Executive Trainer.</i>"." <br> The email id of the user is ".($row["email"])."<br> and the mobile number is ".($row["mobno"]);
