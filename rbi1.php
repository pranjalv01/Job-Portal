...
<div class="banner_1">
	<div class="container">
		<div id="search_wrapper1">
		   <h2 class="white"><i>“Take risks: if you win, you will be happy; if you lose, you will be wise.”</i> –Author Unknown</h2>
		</div>
   </div> 
</div>
...
<div class="container">
    <div class="single">  
        <div class="col-sm-10 follow_left">
			<h3><center>Junior Engineer - RBI</center></h3><br><br>
             <div class="jobs_follow jobs-single-item">
				<div class="thumb"><img src="images/rbi1.jpg" class="img-responsive" alt=""/></div>
				<div class="thumb_right">
				
				<h6 class="title"><a href="#">Reserve bank of india Jobs - Recruitment - RBI Jobs 2018 - 02...</a></h6>
				<span class="meta">banks</span>
        ...
        <div class="col-sm-10 follow_left">
             <div class="jobs_follow jobs-single-item">
				<div class="thumb"><img src="images/rbi1.jpg" class="img-responsive" alt=""/></div>
				<div class="thumb_right">
				<h6 class="title"><a href="#">Core Technical,Govt Jobs,Diploma,Bank,Analyst / Analytics,Logistics / Transportation</a></h6>
				<span class="meta">Engineer (Core, Non-IT)</span>
				<ul class="top-btns">
					<li>
						<a href="#" class="btn_1 fa fa-star-o icon_2"></a>
					</li>
        ...
        <div class="col-sm-10 follow_left">
             <div class="jobs_follow jobs-single-item">
				<div class="thumb"><img src="images/ele.jpg" class="img-responsive" alt=""/></div>
				<div class="thumb_right">
				<h6 class="title"><a href="#">Electronics and Communication Engineer</a></h6>
				...
				<p><h6>Pune</h6></p>
				<p>BE/B.Tech(EEE, ECE, Electrical...)</p>
        ...
        <div class="col-sm-10 follow_left">
             <div class="jobs_follow jobs-single-item">
				<div class="thumb"><img src="images/cse.png" class="img-responsive" alt=""/></div>
				<div class="thumb_right">
				<h6 class="title"><a href="#">Cloud Server Engineer</a></h6>
				<span class="meta">Anantapur</span>
				<ul class="top-btns">
					<li>
						<a href="#" class="btn_1 fa fa-star-o icon_2"></a>
					</li>
