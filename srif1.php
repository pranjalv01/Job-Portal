...
<div class="container">
    <div class="single">  
        <div class="col-sm-10 follow_left">
			<h3><center>Sr Investigator, Field Asst - NARI</center></h3><br><br>
             <div class="jobs_follow jobs-single-item">
				<div class="thumb"><img src="images/fie.jpg" class="img-responsive" alt=""/></div>
				<div class="thumb_right">
				
				<h6 class="title"><a href="#">Field Assistant</a></h6>
				<span class="meta">Qualification 	12TH</span>
				...
				<p><h6>Salary 	Rs. 16,644/- Per Month</h6></p>
        ...
        <div class="col-sm-10 follow_left">
             <div class="jobs_follow jobs-single-item">
				<div class="thumb"><img src="images/fie.jpg" class="img-responsive" alt=""/></div>
				<div class="thumb_right">
				<h6 class="title"><a href="#"> 	Senior Investigator</a></h6>
				<span class="meta">Qualification 	Any Graduate</span>
				<ul class="top-btns">
					<li>
						<a href="#" class="btn_1 fa fa-star-o icon_2"></a>
					</li>
				</ul>
				<p><h6>Salary 	Rs. 30,441/- Per Month</h6></p>
				<p>Job Location 	Banglore</p>
        ...
        <div class="col-sm-10 follow_left">
             <div class="jobs_follow jobs-single-item">
				<div class="thumb"><img src="images/rs1.jpg" class="img-responsive" alt=""/></div>
				<div class="thumb_right">
				<h6 class="title"><a href="#"> 	Research Assistant</a></h6>
				<span class="meta">Qualification 	Any Graduate</span>
				<ul class="top-btns">
					<li>
						<a href="#" class="btn_1 fa fa-star-o icon_2"></a>
				...
				<p><h6>Salary 	Rs. 29,565/- Per Month</h6></p>
